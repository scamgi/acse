...
.text; .global _start; .global sub_ret; _start: lui s0,%hi(test_name); addi s0,s0,%lo(test_name); name_print_loop: lb a0,0(s0); beqz a0,prname_done; li a7,11; ecall; addi s0,s0,1; j name_print_loop; test_name: .ascii "sub"; .byte '.','.',0x00; .balign 4, 0; prname_done:
