...
.text; .global _start; .global divu_ret; _start: lui s0,%hi(test_name); addi s0,s0,%lo(test_name); name_print_loop: lb a0,0(s0); beqz a0,prname_done; li a7,11; ecall; addi s0,s0,1; j name_print_loop; test_name: .ascii "divu"; .byte '.','.',0x00; .balign 4, 0; prname_done:
  ...
  test_6: li x1, 0x80000000; li x2, 1; divu x3, x1, x2;; li x29, 0x80000000; li x28, 6; bne x3, x29, fail;;
  test_7: li x1, 0x80000000; li x2, -1; divu x3, x1, x2;; li x29, 0; li x28, 7; bne x3, x29, fail;;

  test_8: li x1, 0x80000000; li x2, 0; divu x3, x1, x2;; li x29, -1; li x28, 8; bne x3, x29, fail;;
